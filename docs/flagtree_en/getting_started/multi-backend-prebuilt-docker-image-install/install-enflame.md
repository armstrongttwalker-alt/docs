...
# Enflame [enflame](https://github.com/flagos-ai/FlagTree/tree/triton_v3.5.x/third_party/enflame/) (Triton 3.5)
...
# Enflame [enflame](https://github.com/flagos-ai/FlagTree/tree/triton_v3.3.x/third_party/enflame/) (Triton 3.3)
...
wget https://baai-cp-web.ks3-cn-beijing.ksyuncs.com/trans/flagtree-enflame3.3-py310-torch2.7.0-ubuntu22.04.202603.tar.gz
docker load -i flagtree-enflame3.3-py310-torch2.7.0-ubuntu22.04.202603.tar.gz
```
