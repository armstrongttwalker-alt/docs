...
1. 在浏览器中打开<https://flagos.net/login?redirect_url=https%3A%2F%2Fflagos.net%2FHome>。

2. 点击右上角的 **线上实验室** 标签页。选择**手机号登录**或者**邮箱登录**。输入手机号或者邮箱账号，并点击**获取验证码**。填入验证码后，勾选接受社区使用协议及隐私协议，点击**立即登录/注册**。
...
6. 在 **环境访问** 列中，使用以下任一方式访问云端在线开发环境：
    ...
    - **方式二：通过公网访问**  
      ...
      2. 导航至**操作**，并点击设置![alt text](asset/settings.png)。  
